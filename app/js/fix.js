$(document).ready(function () {
   ...
   var insta = false;
    ...
    console.log(instagramStartPosition , 'insta')
    const aboutStartPosition = $("#section-about").offset().top;
    console.log(aboutStartPosition , 'about')
    $('#fullpage').fullpage({
        ...
        onLeave: function (origin, nextIndex, direction) {
            ...
            function bindScroll() {
                ...
                var outerHeight =  $("#section-about").outerHeight()
                var innerWindow =  window.innerHeight;
                console.log(top)
